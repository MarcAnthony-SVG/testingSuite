...
describe('checkAvailablility', function() {
    ...
    it("returns whether they are available or not 1", function() {
      expect(checkAvailability('Tony', true, 1234567890)).to.deep.eq('Tony is available at 1234567890');
    })

    it("returns whether they are available or not 2", function() {
        expect(checkAvailability('Macy', false, 1234567890)).to.deep.eq('Macy is not available');
      })
})